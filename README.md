...
2. Click **Parse & Read** — the app strips markdown, HTML tags, URLs, and punctuation artifacts to produce a clean word list.
...
src/
  ...
  utils/
    ...
    parseEbook.js                — Detects file type and dispatches to the right parser
                                   (includes a hand-rolled PalmDOC decompressor for MOBI/AZW)
  styles/
